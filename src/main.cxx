...
{
    /* signature */
    printf("  eMF 1.3 by Sung-Hun Bae 2008-2022\n\n");
    ...
    int c;
    opterr = 0;
    while ((c = getopt(argc, argv, "hvstLIANDc:x:"))!= -1)
    {
        switch (c) 
        {
            case 'h': 
    ...
    if (D & _GLOBAL_) 
    {
        ...
        */
        if (estimate) 
        {
            ...
            if (estimateFunc == GX2_R2_OVER_R1 )
            {
                ...
                for (A.r=0;A.r<A.NR;A.r++)
                {
                    ...
                    for (f=0;f<A.NF;f++)
                    {
                        ...
                        if (A.flag[A.r] &&
                            gsl_matrix_get(A.X, A.r, f*3+0) > 0.0 && 
            ...
            } // estimateFunc == GX2_R2_OVER_R1_SIMPLE
        ...
        */
        ...
        while fixing the optimized diffusion tensor
